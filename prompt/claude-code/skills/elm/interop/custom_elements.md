...
Here is a minimal example of how to use custom elements to do some localization and internationalization.
...
The most important parts here are attributeChangedCallback
and observedAttributes
. You need some logic like that to detect changes to the attributes you care about.
...
[]
Now you can call viewDate
when you want access to that kind of localized information in your view
.
...
Docs on custom elements can be kind of confusing, but I hope this is enough for people to get started embedding simple logic for Intl
or even large React widgets if that seems like the right choice for your project.
